...
- **A one-line motto per surface helps** when it is true: "see everything, drive
  ...
  overclaims.
- The companion is World-A (private) material like its plan: internal names are fine.
  The public-copy bar is irrelevant here unless the plan itself is public-bearing.
